...
impl pci::Driver for Rtl8169Private {
    ...
    fn probe(pdev: &pci::Device<Core>, info: &Self::IdInfo) -> Result<Pin<KBox<Self>>> {
        ...
        let clk = OptionalClk::get(pdev, "ether_clk")
            .map(|clk| *clk)
            .map_err(|_| {
        ...
        tp.as_mut()
            .set_supports_gmii(*info == Self::IdInfo::NO_GBIT);
        ...
        tp.as_mut().set_dash_enabled(tp.as_ref().rtl_get_dash_type());
        ...
        unsafe {
            if size_of::<bindings::dma_addr_t>() > 4
                ...
                && pdev
                    .dma_set_mask_and_coherent(DmaMask::new::<64>())
                    .is_err()
            {
